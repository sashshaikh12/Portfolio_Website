...
function Navbar() {
    ...
    useGSAP(() => {
        ...
        gsap.from(".logoImage, .nav, .navResume",{
            y:30,
            duration: 1,
            delay: 0.5,
            opacity: 0,
  ...
  return (
    <div className="sticky top-0 z-10 text-white flex justify-between items-center w-full max-w-none mx-auto px-4 bg-[#080808]  font-[Poppins] text-[15px] font-[500]">
        <a href="/"><img src = "namelogo.avif" alt = "logo picture" className="logoImage h-20 hover:cursor-pointer" /></a>
        ...
        <a href="https://drive.google.com/file/d/1YAPP8R59e5zHDXWGUG4RyST61aZZZh8a/view?usp=sharing" className="navResume hidden lg:block p-4 hover:bg-gray-700 hover:rounded-xl hover:cursor-pointer">Resume</a>
