    ...
    return(
        <div className="text-white" id="#">
            <div className="lg:mt-7 max-w-[800px] w-full min-h-screen mx-auto text-center flex flex-col justify-center items-center">
                <img src = "hashirPic.jpg" alt = "hashir's picture" className="h-40 w-40 rounded-full sm:h-64 sm:w-64 mypic"   />
                ...
                <ReactTyped strings={["Competitive Programmer", "Web Developer", "Machine Learning Enthusiast"]} typeSpeed={60} backSpeed={25} loop className="reactTyped pt-6 text-base font-bold sm:text-4xl sm:font-bold md:pt-5 font-[Poppins] md:text-[44px] md:font-[700]" />
