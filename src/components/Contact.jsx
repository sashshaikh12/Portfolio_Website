        ...
        <div className="text-white font-[Poppins] w-full">
            <div className="flex max-w-[800px] flex-col mb-16">
                ...
                <div className="flex justify-center sm:justify-start pt-4 space-x-10 mt-7 sm:pl-16">
                    <SiGithub  className="inline-block mt-7 icon-size"/>
                    <SiLinkedin  className="inline-block mt-7 icon-size"/>
                    <SiGmail  className="inline-block mt-7 icon-size"/>
                    <SiInstagram  className="inline-block mt-7 icon-size"/>
                    <SiCodeforces  className="inline-block mt-7 icon-size"/>
                </div>
            </div>
        </div>
    );
